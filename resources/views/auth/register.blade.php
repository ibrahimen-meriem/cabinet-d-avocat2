                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="tel" class="form-control" name="tel" required autocomplete="new-tel">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="role1" class="col-md-4 col-form-label text-md-end">{{ __('Role') }}</label>
